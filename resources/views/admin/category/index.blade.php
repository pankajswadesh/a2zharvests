        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    @endif
                    <div></div>
                    <div style="padding: 10px;"><a class="btn btn-xs btn btn-success fancybox fancybox.iframe" style="float: right;margin-bottom: 10px" href="{{route('admin::addCategory')}}"><i class="fa fa-plus"></i> Add</a></div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function active_inactive_category(id,status){
                $.ajax({
                    type: "post",
                    url: '{{route('admin::active_inactive_category')}}',
                    data: {
