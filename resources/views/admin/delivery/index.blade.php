...
@section('content')
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Manage Delivery Boy</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Manage Delivery Boy</h1>
        <!-- end page-header -->
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    @endif
                    <div></div>
                    <div style="text-align:right;padding: 10px;"><a class="btn btn-xs btn btn-success fancybox fancybox.iframe" href="{{route('admin::addDelivery')}}"><i class="fa fa-plus"></i> Add</a></div>
    ...
    @push('scripts')
        <script type="text/javascript">
            $('#Datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{route('admin::manageDelivery')}}',
                columns: [
                    ...
                    {data: 'total_tips', name: 'total_tips', orderable: false},
