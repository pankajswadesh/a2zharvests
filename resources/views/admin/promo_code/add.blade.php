            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="{{route('admin::savePromoCode')}}" method="post">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label class="col-md-3 control-label">Promo Code</label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="promo_code" value="{{old('promo_code')}}" placeholder="Enter Promo Code." />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control number" name="discount_percent" value="{{old('discount_percent')}}" placeholder="Enter Discount Percentage" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Discount Upto</label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control number" name="discount_upto" value="{{old('discount_upto')}}" placeholder="Enter Discount Upto" />
                                </div>
                            </div>
                            <div class="form-group">
