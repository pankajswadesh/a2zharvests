            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    ...
                    <div class="panel-body">
                        <form  id="warehouse_form" class="form-inline" action="{{url('cpanel/admin/manage-delivery-boy-report-details',$date)}}" method="get" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="col-md-4">
    ...
    @push('scripts')
        ...
        <script type="text/javascript">
            $('#Datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{url('cpanel/admin/manage-delivery-boy-report-details')}}'+'/'+'{{$date}}'+'?supplier_id='+'{{$supplier_id}}',
                columns: [
