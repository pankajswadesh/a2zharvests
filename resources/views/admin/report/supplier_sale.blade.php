            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    ...
                    <div class="panel-body">
                        <form  id="warehouse_form" class="form-inline" action="{{route('admin::manageSupplierSale')}}" method="get" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="col-md-4">
    ...
    @push('scripts')
        ...
        <script type="text/javascript">
            $('#Datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{route('admin::manageSupplierSale')}}'+'?supplier_id='+'{{$supplier_id}}',
                columns: [
                ...
                "fnDrawCallback": function () {
                    ...
                    $( api.table().footer() ).html(
                        ...
                        '<td>'+ total_sum +'<td><td colspan="3"></td><tr>'
                    );
                    init();
                }
