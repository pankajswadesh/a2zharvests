            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="{{route('admin::saveSupplier')}}" method="post">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="vendor_commision" value="5.00" placeholder="Enter Vendor Comission." />
                                </div>
                            </div>
                            <div id="map"></div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="number" step="any" class="form-control" name="available_distance"  placeholder="Enter available for distance." />
                                </div>
                            </div>
