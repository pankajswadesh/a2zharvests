        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    @endif
                    <div style="text-align:right;padding: 10px;"><a class="btn btn-xs btn btn-success fancybox fancybox.iframe" href="{{route('admin::addUser')}}"><i class="fa fa-plus"></i> Add</a></div>
