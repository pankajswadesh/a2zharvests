...
<body>
<h4 style="text-align:center"> Hello Admin, You Have New Seller Request.</h4>
<p>Name : {{$info["name"]}}</p>
<p>Email : {{$info["email"]}}</p>
<p>Phone : {{$info["phone"]}}</p>
<p>Business Name : {{$info["business_name"]}}</p>
<p>Business Description : {{$info["business_description"]}}</p>
</body>
</html>
